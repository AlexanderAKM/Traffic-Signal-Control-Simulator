...
class SumoEnvironment(gym.Env):
    ...
    Class that implements a gym.Env interface for traffic 
    signal control using the SUMO simulator.
    ...
    def step(self, action: Union[dict, int]):
        ...
        If single_agent is True, action is an int, otherwise it expects
        a dict with keys corresponding to traffic signal ids.
        """
...
# No multi-agent so no need for petting zoo?
